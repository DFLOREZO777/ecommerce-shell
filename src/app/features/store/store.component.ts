  ...
  template: `
    ...
    <div class="social-bar-container">
      <div class="social-nav-size">
        ...
        <a href="https://www.facebook.com/share/1BobSqJDw2/">Sorpresas Mágicas Palestina Chinchiná</a>
        <!-- URL de Instagram:
...
export class StoreComponent implements OnInit {
  ...
  whatsappNumber: string = '573225403797'; // TODO: set actual WhatsApp number
