...
function GoogleLogin(_a) {
  var _b = _a, { onSuccess, onError, useOneTap, promptMomentNotification, type = "standard", theme = "outline", size = "large", text, shape, logo_alignment, width, click_listener, state, containerProps, login_hint } = _b, props = __objRest(_b, ["onSuccess", "onError", "useOneTap", "promptMomentNotification", "type", "theme", "size", "text", "shape", "logo_alignment", "width", "click_listener", "state", "containerProps", "login_hint"]);
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (!scriptLoadedSuccessfully)
      return;
    (_c = (_b2 = (_a2 = window === null || window === void 0 ? void 0 : window.google) === null || _a2 === void 0 ? void 0 : _a2.accounts) === null || _b2 === void 0 ? void 0 : _b2.id) === null || _c === void 0 ? void 0 : _c.initialize(__spreadValues({
      client_id: clientId,
    ...
    return () => {
      var _a3, _b3, _c2;
      if (useOneTap)
        (_c2 = (_b3 = (_a3 = window === null || window === void 0 ? void 0 : window.google) === null || _a3 === void 0 ? void 0 : _a3.accounts) === null || _b3 === void 0 ? void 0 : _b3.id) === null || _c2 === void 0 ? void 0 : _c2.cancel();
    };
  }, [
    clientId,
    scriptLoadedSuccessfully,
  ...
  return import_react.default.createElement("div", __spreadProps(__spreadValues({}, containerProps), { ref: btnContainerRef, style: __spreadValues({ height: containerHeightMap[size] }, containerProps === null || containerProps === void 0 ? void 0 : containerProps.style) }));
}
...
function useGoogleLogin(_a) {
  var _b = _a, { flow = "implicit", scope = "", onSuccess, onError, onNonOAuthError, overrideScope, state } = _b, props = __objRest(_b, ["flow", "scope", "onSuccess", "onError", "onNonOAuthError", "overrideScope", "state"]);
  ...
  (0, import_react.useEffect)(() => {
    ...
    const client = (_b2 = (_a2 = window === null || window === void 0 ? void 0 : window.google) === null || _a2 === void 0 ? void 0 : _a2.accounts) === null || _b2 === void 0 ? void 0 : _b2.oauth2[clientMethod](__spreadValues({
      client_id: clientId,
      ...
      callback: (response) => {
        ...
        (_b3 = onSuccessRef.current) === null || _b3 === void 0 ? void 0 : _b3.call(onSuccessRef, response);
      },
      error_callback: (nonOAuthError) => {
        var _a3;
        (_a3 = onNonOAuthErrorRef.current) === null || _a3 === void 0 ? void 0 : _a3.call(onNonOAuthErrorRef, nonOAuthError);
      },
      state
    }, props));
  ...
  const loginImplicitFlow = (0, import_react.useCallback)((overrideConfig) => {
    var _a2;
    return (_a2 = clientRef.current) === null || _a2 === void 0 ? void 0 : _a2.requestAccessToken(overrideConfig);
  }, []);
  const loginAuthCodeFlow = (0, import_react.useCallback)(() => {
    var _a2;
    return (_a2 = clientRef.current) === null || _a2 === void 0 ? void 0 : _a2.requestCode();
  }, []);
